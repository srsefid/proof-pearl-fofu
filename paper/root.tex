...
Intuitively, $m\le m'$ means that $m$ is a refinement of $m'$, \ie all possible results of $m$ are 
...
If no data refinement is performed, $R_i$ is set to the identity relation, in which case \isai{\<Down>$R_i$} becomes the identity function.
